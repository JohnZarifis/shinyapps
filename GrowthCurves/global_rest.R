...
dbhandle <- odbcDriverConnect("driver={SQL Server Native Client 11.0};server=WIN8-PATRA ;Database=AquaGrowth;Uid=sa;Pwd=1q2w3e!Q@W#E")
...
Sampling <- sqlQuery(dbhandle, "SELECT    ROW_NUMBER() OVER ( PARTITION BY D.CageLotID order by D.CageLotID,CLTranTransDate) AS ROWNUM,
                     ...
                     and IsVirtualSampling = 0",stringsAsFactors = FALSE)
